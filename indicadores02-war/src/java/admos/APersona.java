...
public class APersona implements Serializable {
    ...
    public void autenticacion() {
        ...
        if (!registradoLogin()) {
            ...
            navigationHandler.handleNavigation(FacesContext.getCurrentInstance(), null, "/vista/home?faces-redirect=true");
    ...
    public void redirigirAccceso() {
        creaPersona();
        //navegacion
        NavigationHandler navigationHandler = FacesContext.getCurrentInstance().getApplication().getNavigationHandler();
        navigationHandler.handleNavigation(FacesContext.getCurrentInstance(), null, "/vista/acceso?faces-redirect=true");
